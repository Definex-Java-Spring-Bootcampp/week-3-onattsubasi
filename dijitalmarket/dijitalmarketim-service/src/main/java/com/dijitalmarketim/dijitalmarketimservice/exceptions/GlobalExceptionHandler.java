...
import com.dijitalmarketim.dijitalmarketimservice.exceptions.dto.ExceptionResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(DijitalmarketimException.class)
    public ResponseEntity<ExceptionResponse> handleDijitalmarketimException(DijitalmarketimException exception) {
